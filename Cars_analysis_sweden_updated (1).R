...
coeffs <- coefficients(lm_model); coeffs
...
rf_model <- randomForest(Number_of_Passenger_Cars ~ Year, data = train_data, ntree = 5000)  # Increased number of trees (adjust as needed)
